package com.froyo.pesistence.hibernate;
...
public class HibernateUtil {
    ...
    private static SessionFactory buildSessionFactory() {
        try {
            //Hibernate 5.x
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("hibernatePostgresSQL.cfg.xml").build();
